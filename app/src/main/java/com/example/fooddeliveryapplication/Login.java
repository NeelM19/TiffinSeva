...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            email = (TextInputLayout)findViewById(R.id.Cemail);
            pass = (TextInputLayout)findViewById(R.id.Cpassword);
            Signin = (Button)findViewById(R.id.Cbutton4);
            signup = (TextView) findViewById(R.id.Cdonot);
            Forgotpassword = (TextView)findViewById(R.id.Cforgotpass);
            Signinphone = (Button)findViewById(R.id.Cbtnphone);
